# References - Vernagtferner glacier water-level forecasting

Each reference below was queried against the CrossRef REST API (`https://api.crossref.org/works/{doi}`) and the title plus first author returned by CrossRef were checked against the citation. Entries that did not return a CrossRef hit, or returned a different paper, were dropped from the list. Volume / issue / page numbers are intentionally not included beyond what CrossRef returns; identification rests on the DOI.

## Vernagtferner glaciology and hydrology

1. Hoinkes, H. C. (1952). Warmeumsatz und Ablation auf Alpengletschern I. Vernagtferner (Otztaler Alpen), August 1950. *Geografiska Annaler*. DOI:10.2307/520147.

2. Oerter, H. (1981). Glacial-Hydrological Investigations at the Vernagtferner Glacier as a Basis for a Discharge Model. *Hydrology Research*. DOI:10.2166/nh.1981.0027.

3. Escher-Vetter, H. (1985). Energy Balance Calculations for the Ablation Period 1982 at Vernagtferner, Oetztal Alps. *Annals of Glaciology*. DOI:10.3189/1985aog6-1-158-160.

4. Braun, L. N. (1995). Les resultats principaux de 100 ans de recherche au Vernagtferner, Oetztal (Autriche). *La Houille Blanche*. DOI:10.1051/lhb/1995054.

5. Escher-Vetter, H., and colleagues (2009). Four decades of winter mass balance of Vernagtferner and Hintereisferner, Austria: methodology and results. *Annals of Glaciology*. DOI:10.3189/172756409787769672.

6. Paul, F., and colleagues (2009). Comparison of mass balances for Vernagtferner, Oetzal Alps, as obtained from direct measurements and distributed modeling. *Annals of Glaciology*. DOI:10.3189/172756409787769582.

7. Mayr, E., and colleagues (2011). Glaciological and hydrometeorological long-term observation of glacier mass balance at Vernagtferner (Vernagt Glacier, Oetztal Alps, Austria). *Geological Field Trips in Central Western Europe: Fragile Earth, Munich, 2011*. DOI:10.1130/2011.0022(08).

8. Jager, D., and colleagues (2012). Paraglacial processes on the glacier foreland of Vernagtferner (Otztal Alps, Austria). *Zeitschrift fur Geomorphologie, Supplementary Issues*. DOI:10.1127/0372-8854/2012/s-00099.

9. Lambrecht, A., and colleagues (2023). Discharge characteristics for different glacier mass balance conditions at Vernagtferner, Otztal Alps. *EGU General Assembly 2023*. DOI:10.5194/egusphere-egu23-13841.

## Glacier melt physics: degree-day and energy-balance models

10. Pellicciotti, F., and colleagues (2005). An enhanced temperature-index glacier melt model including the shortwave radiation balance: development and testing for Haut Glacier d'Arolla, Switzerland. *Journal of Glaciology*. DOI:10.3189/172756505781829124.

11. Carenzo, M., Pellicciotti, F., Rimkus, S., and Burlando, P. (2009). Assessing the transferability and robustness of an enhanced temperature-index glacier-melt model. *Journal of Glaciology*. DOI:10.3189/002214309788608804.

12. Heynen, M., Pellicciotti, F., and Carenzo, M. (2013). Parameter sensitivity of a distributed enhanced temperature-index melt model. *Annals of Glaciology*. DOI:10.3189/2013aog63a537.

13. Braithwaite, R. J. (2022). Positive degree-day sums in the Alps: a direct link between glacier melt and international climate policy. *Journal of Glaciology*. DOI:10.1017/jog.2021.140.

14. Phelps, S. R., and colleagues (2025). Regional glacier melt modeling: insights from surface energy balance and positive degree-day comparisons. *Journal of Glaciology*. DOI:10.1017/s0022143025100531.

15. Schaefli, B., Hingray, B., Niggli, M., and Musy, A. (2005). A conceptual glacio-hydrological model for high mountainous catchments. *Hydrology and Earth System Sciences*. DOI:10.5194/hess-9-95-2005.

## Global glacier mass change and runoff implications

16. Marzeion, B., Cogley, J. G., Richter, K., and Parkes, D. (2014). Attribution of global glacier mass loss to anthropogenic and natural causes. *Science* (mirrored on CrossRef as *The Cryosphere* Brief Communication). DOI:10.5194/tc-9-2399-2015.

17. Huss, M., and colleagues (2015). A new model for global glacier change and sea-level rise. *Frontiers in Earth Science*. DOI:10.3389/feart.2015.00054.

18. Huss, M., and Hock, R. (2018). Global-scale hydrological response to future glacier mass loss. *Nature Climate Change*. DOI:10.1038/s41558-017-0049-x.

19. Marzeion, B., Kaser, G., Maussion, F., and Champollion, N. (2018). Limited influence of climate change mitigation on short-term glacier mass loss. *Nature Climate Change*. DOI:10.1038/s41558-018-0093-1.

20. Zemp, M., and colleagues (2019). Global glacier mass changes and their contributions to sea-level rise from 1961 to 2016. *Nature*. DOI:10.1038/s41586-019-1071-0.

21. Hugonnet, R., and colleagues (2021). Accelerated global glacier mass loss in the early twenty-first century. *Nature*. DOI:10.1038/s41586-021-03436-z.

## Snow and climate covariates

22. Kapnick, S., and Hall, A. (2010). Observed Climate-Snowpack Relationships in California and their Implications for the Future. *Journal of Climate*. DOI:10.1175/2010jcli2903.1.

23. Kapnick, S., and Hall, A. (2011). Causes of recent changes in western North American snowpack. *Climate Dynamics*. DOI:10.1007/s00382-011-1089-y.

24. Mudryk, L. R., and colleagues (2015). Characterization of Northern Hemisphere Snow Water Equivalent Datasets, 1981-2010. *Journal of Climate*. DOI:10.1175/jcli-d-15-0229.1.

## Deep learning and machine learning for hydrology

25. Kratzert, F., Klotz, D., Brenner, C., Schulz, K., and Herrnegger, M. (2018). Rainfall-runoff modelling using Long Short-Term Memory (LSTM) networks. *Hydrology and Earth System Sciences*. DOI:10.5194/hess-22-6005-2018.

26. Kratzert, F., Klotz, D., Shalev, G., Klambauer, G., Hochreiter, S., and Nearing, G. (2019). Towards learning universal, regional, and local hydrological behaviors via machine learning applied to large-sample datasets. *Hydrology and Earth System Sciences*. DOI:10.5194/hess-23-5089-2019.

27. Kratzert, F., Herrnegger, M., Klotz, D., Hochreiter, S., and Klambauer, G. (2019). NeuralHydrology - Interpreting LSTMs in Hydrology. *Lecture Notes in Computer Science*. DOI:10.1007/978-3-030-28954-6_19.

28. Kratzert, F., Gauch, M., Nearing, G., and Klotz, D. (2022). NeuralHydrology - A Python library for Deep Learning research in hydrology. *Journal of Open Source Software*. DOI:10.21105/joss.04050.

29. Lim, B., Arik, S. O., Loeff, N., and Pfister, T. (2021). Temporal Fusion Transformers for interpretable multi-horizon time series forecasting. *International Journal of Forecasting*. DOI:10.1016/j.ijforecast.2021.03.012.

30. Nash, J. E., and Sutcliffe, J. V. (1970). River flow forecasting through conceptual models part I - A discussion of principles. *Journal of Hydrology*. DOI:10.1016/0022-1694(70)90255-6.

## ML methods foundations

31. Breiman, L. (2001). Random Forests. *Machine Learning*. DOI:10.1023/A:1010933404324.

32. Friedman, J. H. (2001). Greedy function approximation: a gradient boosting machine. *The Annals of Statistics*. DOI:10.1214/aos/1013203451.

33. Chen, T., and Guestrin, C. (2016). XGBoost: a scalable tree boosting system. *Proceedings of the 22nd ACM SIGKDD International Conference on Knowledge Discovery and Data Mining*. DOI:10.1145/2939672.2939785.

## Glacier observation infrastructure

34. Gartner-Roer, I., and colleagues (2014). A database of worldwide glacier thickness observations. *Global and Planetary Change*. DOI:10.1016/j.gloplacha.2014.09.003.
...
Output: `./additional_references.md`. Top 3 findings:
